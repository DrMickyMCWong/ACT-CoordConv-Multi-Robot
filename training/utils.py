...
class EpisodicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(dataset_path, 'r') as root:
            is_sim = root.attrs.get('sim', False)  # Default to False (real robot) if 'sim' attribute is missing
        ...
        for cam_name in self.camera_names:
            ...
            # Handle depth images - convert to 3-channel format to match RGB  
            if cam_name.endswith('_depth'):
                ...
                # Your data shows 0.000-2.576m range with 0.516m manipulation mean
