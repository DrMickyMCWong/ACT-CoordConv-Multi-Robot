...
def capture_image(pipeline):
    ...
    try:
        ...
        # Resize directly without cropping to avoid deformation
        # This maintains the aspect ratio better and uses the full camera view
...
if __name__ == "__main__":
    ...
    obs = {
        ...
        'images': {cn: capture_image(pipeline) for cn in cfg['camera_names']}
    }
